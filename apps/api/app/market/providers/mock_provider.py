...
class MockMarketDataProvider(MarketDataProvider):
    ...
    def get_market_snapshot(self) -> MarketSnapshotData:
        return MarketSnapshotData(snapshot_time=datetime(2026, 7, 21, 9, 15, tzinfo=timezone.utc), nifty50=24_625.80, sensex=80_420.15, india_vix=13.80, advance_decline_ratio=1.42, market_health_score=78.0)
